...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: '/params',
        component: () => import('@/components/goods/params-two.vue')
      },
      {
        path: '/goods',
        component: () => import('@/components/goods/list-three.vue')
      },
      {
        path: '/add',
        component: () => import('@/components/goods/Add-four.vue')
      },
      {
        path: '/orders',
        component: () => import('@/components/order/order-one.vue')
      }
    ]
  }
